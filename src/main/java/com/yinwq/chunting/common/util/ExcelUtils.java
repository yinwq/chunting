...
public class ExcelUtils {
    ...
    public static void exportCommonExcel(XSSFWorkbook workbook, final String sheetTitle,
                                         final List<String> headers, final List<String[]> dataList,
                                         Integer extType) {
     ...
     * @user lvhonglei
     */
    //    public static Map<String, Object> exportCommonExcel2(XSSFWorkbook workbook,
    ...
    //        for (int i = 0; i < dataList.size(); i++) {
    //            XSSFRow row = sheet.createRow(i + 1);
    //            DynamicBean dynamicBean = (DynamicBean) dataList.get(i);
    //            for (int j = 0; j < params.length; j++) {
    //                XSSFCell cell = row.createCell(j);
    //                cell.setCellStyle(style);
    //                Object value = dynamicBean.getValue(params[j]);
    //                if (value instanceof Boolean) {
    //                    cell.setCellValue(new Boolean(value.toString()));
    //                } else if (value instanceof Integer) {
    //                    cell.setCellValue(value.toString());
